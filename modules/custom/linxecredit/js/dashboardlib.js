            ...
            var option_plazo = jQuery('<div>', {
                        ...
                        jQuery('<div>',{
                            ...
                            jQuery('<div>',{'class':'item-desc', 'id': 'tasa_val'}).append(
                                ...
                                'data-toggle' : 'tooltip',
                                'data-placement' : 'top',
                                'title': 'Es el índice utilizado para medir el costo de tu crédito. La tasa de interés cobrada por Linxe en todos los créditos no sobrepasa la máxima permitida la Superintendencia Financiera para créditos de consumo ordinarios.',
    ...
    function calcular(){     
        ...
        jQuery.each(jQuery('.cont-plazo'), function(){
           current_plazo = parseInt(jQuery(this).attr('data-option'));
            ...
            cuota_tecnologia = (cantidad * cargo_tecnologia) / 100;
